...
stochastic_nose_cone = StochasticNoseCone(
    nosecone = BuildingRocket.nose_cone,
    length = 0.001
)
...
stochastic_rail_buttons = StochasticRailButtons(
    rail_buttons = BuildingRocket.rail_buttons,
    buttons_distance = 0.001
)

stochastic_main = StochasticParachute(
    parachute = BuildingRocket.main,
    cd_s = 0.1,
    lag = 0.1
)

stochastic_drogue = StochasticParachute(
    parachute = BuildingRocket.drogue,
    cd_s = 0.07,
    lag = 0.2
)
...
stochastic_rocket.add_tail(
    stochastic_tail
)

stochastic_rocket.set_rail_buttons(
    stochastic_rail_buttons,
    lower_button_position = (0.001, "normal")
)
